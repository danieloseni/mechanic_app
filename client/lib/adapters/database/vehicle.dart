...
class VehicleDBHelper{
 static final VehicleDBHelper _dbHelper =  VehicleDBHelper._internal();
 String table = 'vehicles';

 VehicleDBHelper._internal();

 factory VehicleDBHelper(){
   return _dbHelper;
 }
...
Future<Database> get db async{
 ...
 void _createDb(Database db, int newVersion) async{
   await db.execute(
     "CREATE TABLE $table(brand TEXT, firstname TEXT, lastname TEXT, email TEXT, phone TEXT, password TEXT, token TEXT)"
   );
